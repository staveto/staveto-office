...
export default function EstimateDetailPage() {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    validItems.forEach((item, i) => {
      ...
      if (item.unitPrice < 0)
        err[`item_${i}_price`] = "Price cannot be negative";
    });
  ...
  async function handleDelete() {
    ...
    try {
      ...
      setErrors({ delete: "Failed to delete estimate" });
    } finally {
      setDeleting(false);
    }
  }
      ...
      <div className="space-y-6">
        <div className="rounded-lg border border-destructive/50 bg-destructive/10 p-6 text-center">
          ...
          <p className="text-muted-foreground mt-2">
            The estimate you&apos;re looking for doesn&apos;t exist or was deleted.
          </p>
          <Link
            href="/estimates"
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        ...
        >
          ...
          <div>
            <h1 className="text-2xl font-semibold">{title || "Estimate"}</h1>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  This action cannot be undone. The estimate will be permanently
                  removed.
                </DialogDescription>
              </DialogHeader>
              <DialogFooter>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Basic information about the estimate.
            </CardDescription>
          </CardHeader>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Add items with quantity, unit, and price.
                </CardDescription>
              </div>
